...
# 브랜드검색
incase_wb.naver_brand_sa_write('네이버 브랜드검색', incase_brand_search_pc_data, 56, 18333)
incase_wb.naver_brand_sa_write('네이버 브랜드검색', incase_brand_search_mob_data, 91, 66000)
